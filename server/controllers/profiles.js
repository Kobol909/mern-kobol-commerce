...
const updatePasswordSchema = Joi.object({
  currentPassword: Joi.string().messages(constants.ERROR_MESSAGE_CURRENT_PASSWORD).required(),
  password: Joi.string().min(8).messages(constants.ERROR_MESSAGE_PASSWORD).required()
});
    ...
    updatePasswordSchema
      ...
      .then((payload) => {
        ...
        if (req.body.password === req.body.currentPassword) {
          throw createError(422, 'New password is the same as current password');
        }
